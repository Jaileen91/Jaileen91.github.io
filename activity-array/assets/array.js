...
function DrawList() {
    ...
    document.getElementById("tableWorkers").innerHTML = "<table id='workers'><td colspan='4'><h5>List of Workers</h5></td><tr></tr><td>ID</td><td>Name</td><td>Hours</td><td>ACTION</td>"+List+"</table>";
}